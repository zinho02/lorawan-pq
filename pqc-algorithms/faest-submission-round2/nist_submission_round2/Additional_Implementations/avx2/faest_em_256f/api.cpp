...
using faest_params = faest::v2::faest_em_256_f;
using faest_scheme = faest::faest_scheme<faest_params>;

static_assert(faest_scheme::CRYPTO_SECRETKEYBYTES == 64);
static_assert(faest_scheme::CRYPTO_PUBLICKEYBYTES == 64);
static_assert(faest_scheme::CRYPTO_BYTES == 23476);
